                ...
                <div class="ctn-land-hero">
                 ...
                 <div class="ctn-images-hero">
                    <div class="ctn-img-bg-1">
                        <img class="first" src="{{ asset('multimedia/img/corn.png') }}" alt="">
                    </div>
                    <div class="ctn-img-bg-2">
                        <img class="second" src="{{ asset('multimedia/img/broco.png') }}" alt="">
                    </div>
                    <div class="ctn-img-bg-3">
                        <img class="third" src="{{ asset('multimedia/img/horia.png') }}" alt="">
                    </div>
                    <div class="ctn-img-bg-4">
                        <img class="fourth" src="{{ asset('multimedia/img/tomate_2.png') }}" alt="">
                    </div>
